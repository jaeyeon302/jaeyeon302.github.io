...
1. HD 한국조선해양, Modular multilevel converter 기반 Medium-Voltage Drive 개발 (2022.01 )  
2. HD 한국조선해양, 전기추진선박 내 Medium-voltage dc를 위한 LLC 기반 Direct Current Transformer 개발 (2025.01 - )  

## Research
### Motor Drive & Nonlinear Optimization
...
그 중, 최적화 이론을 매입형영구자석동기전동기에서 약자속 운전에 접목시킴으로써, 
참조표와 신호주입 없이도 전동기의 포화를 고려한 정확하고 빠른 토크 제어를 수행할 수 있도록 하는 연구를 진행했습니다.
...
1. **J. Park**, D. Kim, S. Cui and S. Sul, "Design and Implementation of PC-based Realtime Control System with EtherCAT Network"  in _Power Electronics Conference_, THE KOREAN INSTITUTE OF POWER ELECTRONICS, 2022, pp. 16-18.
2. D. Kim, **J. Park** and S. Cui, "Control of Parallel Converter Using EtherCAT based Control System" in _Power Electronics Conference_, THE KOREAN INSTITUTE OF POWER ELECTRONICS, 2022, pp. 348-350.
3. D. Kim, **J. Park** and S. Cui, "Induction Motor Drive based on EtherCAT MMC Control System" in _Power Electronics Conference_, THE KOREAN INSTITUTE OF POWER ELECTRONICS, 2023, pp. 219-221.
4. S. Lee, D. Kim, **J. Park**, S. Lee, J. Jung and S. Cui, "EtherCAT Star topology based MMC control system implementation" in _Power Electronics Conference_, THE KOREAN INSTITUTE OF POWER ELECTRONICS, 2024, pp. 223-225.  

위 과정을 통해 개발한 EtherCAT-기반 MMC 제어시스템을 [2023년-200 kW MMC](https://www.jaeyeonpark.kr/ethercat-lv-mmc.html), [2025년 3 MW MMC](https://www.jaeyeonpark.kr/mmc-mvdrive.html) 탑재해 실증하였습니다.
...
1. **J. Park** et al., “Equivalent Circuit Extraction of MI-HTS Coil Including High-Frequency Region for Electromagnetic Transient Simulation With Voltage-Source Converter,” in _IEEE Transactions on Applied Superconductivity_, vol. 35, no. 7, pp. 1-11, Oct. 2025, Art no. 3800911, doi: [10.1109/TASC.2025.3587992](https://ieeexplore.ieee.org/document/11077368).  

컨버터 모델링과 관련하여, [윤종훈](https://ieeexplore.ieee.org/author/37088461102) 박사님과 
Multi-active Bridge Converter를 실시간 시뮬레이터에서 구현하는 연산 최적화 기법을 연구했습니다.  

2. J. Yun, **J. Park**, S. Moon, G. De Carne and S. Cui, “Resource-Efficient Real-Time Simulation of Multi-Active Bridge Converters Using Modular Programming,” _2025 IEEE Kiel PowerTech_, Kiel, Germany, 2025, pp. 1-6, doi: [10.1109/PowerTech59965.2025.11180564](https://ieeexplore.ieee.org/document/11180564).  

최성휘 교수님 연구실에선 Grid-forming과 같은 계통연계형 컨버터 제어 연구가 활발히 이뤄지고 있는 가운데,
Supercapacito를 기반으로 한 E-STATCOM 제어기법이 연구된 바 있는데, 
그 중 저는 System modeling과 결부하여 운전시 소신호 안정도 분석을 수행했습니다.  

3. Junyeol Maeng, Jisun Ham, Gayoung Park, **Jaeyeon Park**, Heng Wu, Jae-Jung Jung, Shenghui Cui, “A supercapacitor size minimization and energy management strategy for E-STATCOM connected to weak grid”, International Journal of Electrical Power & Energy Systems, Volume 172, 2025, 111174, ISSN 0142-0615, [https://doi.org/10.1016/j.ijepes.2025.111174](https://www.sciencedirect.com/science/article/pii/S0142061525007227?via%3Dihub).  
...
1. **J. Park**, D. Kim, S. Lee, J. -J. Jung, S. -K. Sul and S. Cui, “Partial Power-Hardware-in-the-Loop Test for In-Situ Dynamic and Steady-State Validation of a Single Submodule in a Megawatt-Scale MMC,” in _IEEE Transactions on Power Electronics_, doi: [10.1109/TPEL.2025.3642797](https://ieeexplore.ieee.org/document/11297165).  
2. S. Lee, D. Kim, **J. Park**, S. Cui and J. Jung, "Development of Power-HILS Verification Platform for MMC Submodule Testing" in _Power Electronics Conference_, THE KOREAN INSTITUTE OF POWER ELECTRONICS, 2024, pp. 229-231.  

[3 MW MMC](https://www.jaeyeonpark.kr/mmc-mvdrive.html)에서 개발한 MMC의 Front-to-Front 테스트를 현재 
개발하고 있으며, 이에 대한 개념적인 시험 방법론을 정리해 아래 학술대회논문으로 작성하였습니다.  

3. **J. Park** et al., “MMC-Based High-Power Motor Emulator for Testing of Electrical Propulsion System,” _2025 IEEE Electric Ship Technologies Symposium (ESTS)_, Alexandria, VA, USA, 2025, pp. 162-169, doi: [10.1109/ESTS62818.2025.11152450](https://ieeexplore.ieee.org/document/11152450).  

Medium-voltage dc 배전을 사용하는 차세대 전기추진함정에서 축발전기를 통해 Start-up 시간을 단축할 수 있는 
연구를 진행했습니다.  

4. S. Moon, **J. Park**, D. Kim and S. Cui, “Generator Operation Strategy for Naval Vessels with MVDC Distribution in Combat Situations,” _2025 IEEE Electric Ship Technologies Symposium (ESTS)_, Alexandria, VA, USA, 2025, pp. 149-153, doi: [10.1109/ESTS62818.2025.11152412](https://ieeexplore.ieee.org/document/11152412).  
